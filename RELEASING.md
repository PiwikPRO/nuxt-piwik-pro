...
Maintainer guide for publishing a new version of `@piwikpro/nuxt-piwik-pro` to npm.
...
6. Publishing the GitHub Release triggers `main.yml`, which builds and publishes
   to npm. Verify at
   <https://www.npmjs.com/package/@piwikpro/nuxt-piwik-pro>.

## Notes

- When you create the GitHub Release, type the tag **unprefixed** (`1.5.1`, not
  `v1.5.1`). This matches the existing tag history and the changelog compare
